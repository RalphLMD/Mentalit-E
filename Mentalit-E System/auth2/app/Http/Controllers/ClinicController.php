...
class ClinicController extends Controller
{
    ...
    public function single(Clinic $clinic, Subscription $subscriptions) { //view own clinic
        ...
        $ratings = Rating::where('clinic_id', $var->clinic_id)->get();
        return view ('/clinic/clinic/single', ['clinic' => $clinic, 'ratings'=>$ratings]); 
    }
    ...
    public function display_employee(Clinic $clinic) {
        ...
        return view ('/clinic/employee/index', ['clinic'=>$clinic]); //return results
    }
    ...
    public function update_employee(Request $request, $id) {
        ...
        if($employee->accountStatus == "Active") {
            ...
            $message = "Employee has been archived";
        } else {
    ...
    public function display_records() {
        ...
        return view('/clinic/record/index', ['clinic'=>$clinic]);
    }
