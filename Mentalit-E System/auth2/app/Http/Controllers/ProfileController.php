...
class ProfileController extends Controller
{
    ...
    public function store_journal(Request $request) {
        ...
        return redirect()->back()->with('message', 'Journal entry has been created');
    }
    ...
    public function update_journal(Request $request, $id) {
        ...
        return redirect()->back()->with('message', 'Journal entry has been updated');
    }
    ...
    public function delete_journal(Request $request, $id) {
        ...
        return redirect()->back()->with('message', 'Journal entry has been deleted');
    }
