...
class SystemAdministratorController extends Controller
{
    ...
    public function store_notification(Request $request, $users) {
        ...
        return redirect()->back()->with('message', 'Notification has been sent to the user');
    }
    ...
    public function store_warning(Request $request, $users) {
        ...
        return redirect()->back()->with('message', 'Warning has been sent to the user');
    }
    ...
    public function store_award_user(Request $request, $users) {
        ...
        return redirect()->back()->with('message', 'Award has been sent to the user');
    }
    ...
    public function store_ticket(Request $request) {
        ...
        return redirect()->back()->with('message', 'Ticket has been filed');
    }    
