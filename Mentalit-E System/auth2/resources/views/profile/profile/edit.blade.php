            ...
            <div class="shadow p-5 w-100 standard">
                ...
                <div class="text-center">
                    @if ($user->profile_image == null)  
                        <img src="{{ asset('storage/avatars/default.png')}}" width=150>		
                    @else
                        <img src="{{ asset('storage/avatars/'.$user->profile_image) }}" class="profile" width=150>
                    @endif	
                    <form action="/profile/profile/updateimage" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <input class="form-control w-25 m-auto mt-3" type="file" name="profile_image" accept="image/*" required autocomplete="profile_image">
                        @error('profile_image')
