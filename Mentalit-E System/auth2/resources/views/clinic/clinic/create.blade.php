        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <div class="mb-3 w-75 auto">
                    ...
                    <input class="form-control @error('birLicense') is-invalid @enderror" type="file" accept="image/*, application/pdf, application/msword" name="birLicense" required autocomplete="birLicense">			
                    @error('birLicense')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="mb-3 w-75 auto">
                    ...
                    <input class="form-control @error('prcLicense') is-invalid @enderror" type="file" accept="image/*, application/pdf, application/msword" name="prcLicense" required autocomplete="prcLicense">	
                    @error('prcLicense')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="mb-3 w-75 auto">
                    ...
                    <input class="form-control" type="file" accept="image/*, application/pdf, application/msword" name="paymentProof" required autocomplete="paymentProof">	
                    @error('paymentProof')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
