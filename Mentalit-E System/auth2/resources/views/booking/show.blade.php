    ...
    <div class="row border p-5 shadow-lg">
        ...
        <br>
            @if ($clinic->clinicMainPhoto == null)  
                <img src="{{ asset('storage/avatars/hospital.png')}}" class="img-fluid my-5 me-5" width=150>		
            @else
                <img src="{{ asset('storage/avatars/'.$clinic->clinicMainPhoto) }}" class="img-fluid" width=150>
            @endif	
        </div>
        ...
        <div class="col-lg-12 mt-5 text-left">
            ...
            <div class="d-flex justify-content-start">
                ...
                @if ($rating->userRating->profile_image == null)  
                    <img src="{{asset('img/user.png')}}" class="profile" width=50>	
                @else
                    <img src="{{ asset('storage/avatars/'.$rating->userRating->profile_image) }}" class="profile" width=50>
                @endif	                 
                </div>
