        ...
        <div class="col-lg-9">
            ...
            <div class="shadow p-5 w-100 standard">
                ...
                @if($var->ticketStatus != "Closed" && $var->ticketStatus != "Archived")
                    ...
                    @csrf
                    @method('PUT')
                    <textarea class="form-control" rows="4" name="ticketCommentContent"></textarea>


                    <div class="mt-5 w-50 auto">
                        <label class="form-label text-center bold">Attachment (if applicable)</label>
                        <input class="form-control w-75 auto" type="file" name="file">	           
                    </div>  
                    ...
                    @forelse ($comments as $comment)
                        ...
                        <div class="d-flex justify-content-start">
                            ...
                            <div class="p-2 bd-highlight">
                                ...
                                @else
                                    <img src="{{ asset('storage/avatars/'.$comment->userTicketComment->profile_image) }}" class="profile" width=50>
                                @endif	                 
                            </div>
                        </div>
                        <br><hr>	
